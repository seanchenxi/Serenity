...
import com.seanchenxi.serenity.client.SerenityUtil;
import com.seanchenxi.serenity.client.event.ReplyDiscussionEvent;
import com.seanchenxi.serenity.client.event.ReplyDiscussionEvent.HasReplyDiscussionHandlers;
import com.seanchenxi.serenity.client.resource.SerenityResources;
...
public class DiscussionViewImpl extends Composite implements HasReplyDiscussionHandlers {
  ...
  public interface Resources extends ClientBundle {
    ...
    public interface Style extends CssResource {
      final static String DEFAULT_CSS = "com/seanchenxi/serenity/client/resource/view/DiscussionView.css";
      String discussion();
    ...
    @ClientBundle.Source("com/seanchenxi/serenity/client/resource/image/avatar32.png")
