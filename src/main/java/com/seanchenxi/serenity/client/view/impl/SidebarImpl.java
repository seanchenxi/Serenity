 ...
 */
package com.seanchenxi.serenity.client.view.impl;
...
import com.seanchenxi.serenity.client.view.Sidebar;
import com.seanchenxi.serenity.client.widget.NavigationBar;
import com.seanchenxi.serenity.client.widget.NavigationItem;
import com.seanchenxi.serenity.client.widget.PopupLabelBox;
...
public class SidebarImpl implements Sidebar {
  ...
  public interface Resources extends ClientBundle {
    ...
    public interface Style extends CssResource {
      final static String DEFAULT_CSS = "com/seanchenxi/serenity/client/resource/view/SideBar.css";
      String sideBar();
    }
    ...
    @Source("com/seanchenxi/serenity/client/resource/image/black/home.png")
    ImageResource icon_Home_black();

    @Source("com/seanchenxi/serenity/client/resource/image/black/search.png")
    ImageResource icon_Search_black();

    @Source("com/seanchenxi/serenity/client/resource/image/black/grid.png")
    ImageResource icon_Grid_black();

    @Source("com/seanchenxi/serenity/client/resource/image/black/info.png")
